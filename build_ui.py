...
.roster-head{display:flex;justify-content:space-between;align-items:baseline;flex-wrap:wrap;gap:8px;margin:0 0 14px}
.roster-head .section{margin:0}   /* gap below the head comes from the head's margin, not the h2's — one source */
...
@media (max-width:560px){
  ...
  .chip{border-radius:16px}   /* fixed radius so 1-line and 2-line chips share ONE shape (the 999px pill turns
                                 into a lozenge when wrapped, reading as unintentional). Revert: delete this line. */
